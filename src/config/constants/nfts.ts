...
export const PANKNX_RABBITS_ADDRESS = '0xDf7952B35f24aCF7fC0487D01c8d5690a60DBa07'

const Nfts: Nft[] = [
  {
    name: 'Swapsies',
    description: 'These bunnies love nothing more than swapping koninexs. Especially on BSC.',
  ...
  {
    name: 'Drizzle',
    description: "It's raining arena on this bunny, but he doesn't seem to mind. Can you blame him?",
  ...
  {
    name: 'Blueberries',
    description: "These bunnies like their koninexs with blueberries. What's your favorite topping?",
  ...
  {
    name: 'Circular',
    description: "Love makes the world go 'round... but so do koninexs. And these bunnies know it.",
  ...
  {
    name: 'Sparkle',
    description: 'It’s sparkling arena, koninexs, and even lottery tickets! This bunny really loves it.',
