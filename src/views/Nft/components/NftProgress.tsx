...
import { Card, CardBody, Heading, OpenNewIcon, Text, Link as UIKitLink, Progress } from '@koninex/uikit'
  ...
  return (
    <Card>
      <CardBody>
        ...
        <Message>{TranslateString(999, 'NFTs can be traded in for KNX until the above block height')}</Message>
      </CardBody>
    </Card>
  )
}
