...
import { Button, Heading, Text as UIKitText, ArrowForwardIcon } from '@koninex/uikit'
        ...
        <Section>
          ...
          <Row>
            ...
            <Text>
              {TranslateString(
                638,
                "Winners can trade in their NFTs for a KNX value until the expiry date written below. If you don't trade in your NFT by then, don’t worry: you’ll still keep it in your wallet!",
              )}
            </Text>
          </Row>
        </Section>
