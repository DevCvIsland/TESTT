...
import { Heading, CardBody, CardFooter, KoninexRoundIcon, TicketRound } from '@koninex/uikit'
      ...
      <>
        <CardBody>
          <CardHeading>
            ...
            <LotteryCardHeading
              valueToDisplay={TranslateString(999, `${poolSize.toLocaleString()} KNX`)}
              Icon={KoninexRoundIcon}
            >
