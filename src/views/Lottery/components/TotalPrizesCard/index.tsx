...
import { Heading, Card, CardBody, CardFooter, Text, KoninexRoundIcon, Flex, Skeleton } from '@koninex/uikit'
        ...
        <CardHeading>
          <Left>
            ...
            <PrizeCountWrapper>
              ...
              <Heading size="lg">{lotteryPrizeWithCommaSeparators} KNX</Heading>
            </PrizeCountWrapper>
          </Left>
          <Right>
